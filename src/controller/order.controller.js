...
//(It is very important to get all the order value from the backend because from frontend it can be manipulated)
...
export const generateRazorpayOrderId = asyncHandler(async (req, res) => {
    ...
    // Product calculation based on DB calls
...
export const generateOrder = asyncHandler(async(req, res) => {
    //add more fields below from order schema
